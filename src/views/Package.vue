<template>
  <div>
    ...
    <div v-if="!pickup">
      <b>Sender phone number :{{ packageDetails.sender }}</b
      ><br />
      <b>Receiver phone number : {{ packageDetails.phone_number }}</b
      ><br />
      <b>Inbox : {{ packageDetails.inbox }}</b
      ><br />
      <b>Email : {{ packageDetails.email }}</b
      ><br />
      <b>Title : {{ packageDetails.title }}</b
      ><br />
